...
$sitename = "<strong>bull</strong><strong style=\"color: #ff0000\">DUMP</strong>";
?>
<html>
<head>
<script>
...
<nav class="navbar fixed-top navbar-expand-lg navbar-dark" style="background-color: #2e8808"> <a class="navbar-brand" href="index.php"><?php echo $sitename; ?></a>
